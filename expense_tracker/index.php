...
&& !empty($_POST['expense_description'])){  
  ...
  // exit;
    ...
    $getAll = mysqli_query($con, "SELECT expense_category_name, amount FROM expense_category_tbl WHERE expense_category_id ='".$expense_category_id." ' && userId = '$userId' ");
    ...
    $getBal = mysqli_query($con, "SELECT expense_category_id, SUM(amount_spent) AS amount_spent FROM expense_tbl WHERE expense_category_id ='".$expense_category_id." '&& userId = '$userId' GROUP BY  expense_category_id ");
    $sum=0;
...
//exit;
    ...
    $userId = $_SESSION['userid'];
		$data = mysqli_query($con, "INSERT INTO expense_tbl(expense_category_id,expense_description,expense_date,created_at,deleted,amount_spent,userId)
      VALUES('".$expense_category_id."','".$expense_description."','".$expense_date."','".$created_at."','".$zero."','".$amount_spent."','$userId')");
		}	
...
<body>
 ...
 ?>          
    ...
    <div class="content">
        ...
        <div class="form-group col-md-6">
          <label for="expense_category_id">Expense Name:</label>
            <select class="form-control" name="expense_category_id" id="expense_category_id"  required="">
              ...
              <?php 
              $userId = $_SESSION['userid'];
                $getAll = mysqli_query($con, "SELECT * FROM expense_category_tbl WHERE userId = '$userId' order by expense_category_name ASC");
        ...
        <div class="form-group col-md-6">
    <label>Date:</label>
    <input type="date" name="expense_date" id="expense_date" class="form-control" placeholder="Please Enter Expense Date:" onBlur="setDateRange()" required>
</div>
<script>function setDateRange() {
    ...
    $userId = $_SESSION['userid'];
           ...
           FROM expense_tbl i, expense_category_tbl s  WHERE (i.expense_category_id = s.expense_category_id) && (i.userId=$userId) group by i.expense_category_id");
