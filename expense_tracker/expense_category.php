...
if(isset($_POST['submit']) && !empty($_POST['amount']) && !empty($_POST['expense_category_name'])){  
    ...
    $sql = "SELECT expense_category_name  FROM expense_category_tbl WHERE expense_category_name = '$expense_category_name' && userId = '$userId' ";
  ...
  header('expense_category.php');
		...
		$data = mysqli_query($con, "INSERT INTO expense_category_tbl(expense_category_name, created_at, amount,userId) VALUES('".$expense_category_name."', '".$created_at."','".$amount."','$userId')");
		}	
...
<body>
 ...
 ?>          
       ...
       <input type="text" name="expense_category_name" id="expense_category_name" class="form-control" placeholder="PLease Enter Expense Name"  required>
              ...
              <div class="form-group col-md-12">
                <label> Budget Allocation : </label>
                  <input type="text" name="amount" id="amount"  class="form-control"placeholder="Enter Budget You Allocated"   onBlur="this.value=trim(this.value);" required>
        </div>
       </div>
    ...
    <!-- </div> -->
        ...
        <?php
        $userId = $_SESSION['userid'];
					$sql = mysqli_query($con, "SELECT * FROM expense_category_tbl where userId = '$userId'  order by expense_category_name ASC");
